...
[
	...
	[[16718.3,10221.6,0],25,true],	// Hero Air
...
[_infiSZ] spawn {
    ...
    _startSafeZone =
    {
        ...
        {
            _msg = 'You entered a Safe Zone!, Vehicles Left In Safe Zone Will Be Unlocked After Restart!';
            hint _msg;
    ...
    _endSafeZone =
    {
        ...
        //fnc_veh_handleDam = compile preprocessFileLineNumbers 'scripts\no_vehicles_safezone.sqf';
