...
#define START_ITEMS "ItemBandage",1,"ItemPainkiller","ItemWaterbottle","FoodPistachio"
class_public = [ // These are visible to anyone on the server
	[(localize "str_playerstats_bandit")+" Lvl1","GUE_Commander_DZ","BB_Merc_OA_Female_light",[START_ITEMS,"17Rnd_9x19_glock17",2],["G17_DZ","ItemGPS","ItemRadio","ItemToolbox"],"",[],[],0,-5000,0,""],
	[(localize "str_playerstats_bandit")+" Lvl2","Ins_Soldier_2_DZ","BB_Merc_OA_Female_light",[START_ITEMS,"17Rnd_9x19_glock17",3,"ItemMorphine"],["G17_DZ","ItemGPS","ItemRadio","ItemToolbox"],"DZ_Assault_Pack_EP1",[],[],0,-10000,0,""],
	[(localize "str_playerstats_bandit")+" Lvl3","Sniper1_DZ","BB_Merc_OA_Female_light",[START_ITEMS,"17Rnd_9x19_glock17",4,"ItemMorphine"],["G17_DZ","ItemGPS","ItemRadio","ItemToolbox"],"DZ_TK_Assault_Pack_EP1",[],[],0,-15000,0,"MeleeHatchet"],
		[(localize "str_playerstats_bandit")+" Lvl4","gsc_eco_stalker_mask_fred","BB_Merc_OA_Female_light",[START_ITEMS,"17Rnd_9x19_glock17",4,"ItemMorphine"],["G17_DZ","ItemGPS","ItemRadio","ItemToolbox"],"DZ_TK_Assault_Pack_EP1",[],[],0,-40000,0,"MeleeHatchet"],
	[(localize "str_playerstats_hero")+" Lvl1",if (class_epoch) then {"GUE_Commander_DZ"} else {"Survivor3_DZ"},"BB_Merc_OA_Female_light",[START_ITEMS,"6Rnd_45ACP",2],["Revolver_DZ","ItemGPS","ItemRadio","ItemToolbox"],"",[],[],0,5000,0,""],
	[(localize "str_playerstats_hero")+" Lvl2",if (class_epoch) then {"UN_CDF_Soldier_Guard_EP1"} else {"Survivor3_DZ"},"BB_Merc_OA_Female_light",[START_ITEMS,"6Rnd_45ACP",3,"ItemMorphine"],["Revolver_DZ","ItemGPS","ItemRadio","ItemToolbox"],"DZ_Assault_Pack_EP1",[],[],0,10000,0,""],
	[(localize "str_playerstats_hero")+" Lvl3",if (class_epoch) then {"Soldier_Sniper_PMC_DZ"} else {"Survivor3_DZ"},"BB_Merc_OA_Female_light",[START_ITEMS,"6Rnd_45ACP",4,"ItemMorphine"],["Revolver_DZ","ItemGPS","ItemRadio","ItemToolbox"],"DZ_TK_Assault_Pack_EP1",[],[],0,15000,0,"MeleeHatchet"],
		[(localize "str_playerstats_hero")+" Lvl4",if (class_epoch) then {"gsc_military_helmet_grey"} else {"Survivor3_DZ"},"BB_Merc_OA_Female_light",[START_ITEMS,"6Rnd_45ACP",4,"ItemMorphine"],["Revolver_DZ","ItemGPS","ItemRadio","ItemToolbox"],"DZ_TK_Assault_Pack_EP1",[],[],0,40000,0,"MeleeHatchet"],
	[localize "str_playerstats_survivor","Haris_Press_EP1_DZ","BB_Merc_OA_Female_light",[START_ITEMS,"8Rnd_9x18_Makarov",2],["Makarov_DZ","ItemGPS","ItemRadio","ItemToolbox"],"",[],[],0,0,0]
];
