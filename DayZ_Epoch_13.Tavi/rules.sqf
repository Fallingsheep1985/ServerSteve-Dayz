...
_messages = [
	...
	["World", worldName],
	["Host", "Hosted By GTXGaming"],
	["Server Rules", "Duping, glitching or using any<br />exploit will result in a<br />permanent ban."],
	["Server Rules", "No talking in side, English Only."],
	["Server Rules", "Hackers will be banned permanently<br />Respect others"],
	["Server Rules", "No Building Within Trader Cities<br />No Base Building / Blocking High Value Loot Buildings"],
