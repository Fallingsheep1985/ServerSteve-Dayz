...
action1script = {((ctrlParent (_this select 0)) closeDisplay 7777); execvm 'addons\suicide\suicide.sqf';}; //script that action button 1 will use

_action2Text = "Locate your vehicles"; //Text that will go on action button 2
action2script = {((ctrlParent (_this select 0)) closeDisplay 7777); execvm 'scripts\locate_vehicle.sqf';}; //script that action button 2 will use
...
_deployable1Text = "Fast Bike"; //Text that will go on deployable button 1
...
deployable1script = {((ctrlParent (_this select 0)) closeDisplay 7777); execvm 'scripts\bike\deploy.sqf';}; //script that deploy button 2 will use
//deployable1script = {execvm 'scripts\bike\deploy.sqf';};//script that deploy button 1 will use
